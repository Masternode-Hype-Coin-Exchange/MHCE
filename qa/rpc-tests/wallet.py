...
#   c) node1 mines 32 blocks, so now node 0 has 60001MHCE, node 1 has 4250MHCE, node2 has none.
#   d) node0 sends 601 MHCE to node2, in two transactions (301 MHCE, then 300 MHCE).
