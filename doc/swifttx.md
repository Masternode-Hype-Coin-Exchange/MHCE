...
This mechanism has been integrated into Bitcore-Node-MasternodeHypeCoinExchange which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Masternode-Hype-Coin-Exchange-Project/insight-api-mhce#web-socket-api](https://github.com/Masternode-Hype-Coin-Exchange-Project/insight-api-mhce#web-socket-api) 
* API: [https://github.com/Masternode-Hype-Coin-Exchange-Project/insight-api-mhce#swifttx-transactions](https://github.com/Masternode-Hype-Coin-Exchange-Project/insight-api-mhce#swifttx-transactions) 
...
By default, the MasternodeHypeCoinExchange daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MasternodeHypeCoinExchange daemon:
