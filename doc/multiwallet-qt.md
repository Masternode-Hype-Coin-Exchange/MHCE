...
In order to support loading of multiple wallets in mhce-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mhce.cpp.
...
Changes to mhce.cpp
----------------------
mhce.cpp is the entry point into mhce-qt, and as such, will require some minor modifications to provide hooks for
