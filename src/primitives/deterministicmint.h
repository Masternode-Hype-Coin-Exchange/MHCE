...
#ifndef MasternodeHypeCoinExchange_DETERMINISTICMINT_H
#define MasternodeHypeCoinExchange_DETERMINISTICMINT_H
...
#endif //MasternodeHypeCoinExchange_DETERMINISTICMINT_H
