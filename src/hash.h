...
#ifndef MasternodeHypeCoinExchange_HASH_H
#define MasternodeHypeCoinExchange_HASH_H
...
#define ZBMHCE (memcpy(&ctx_bmw, &z_bmw, sizeof(z_bmw)))
...
#endif // MasternodeHypeCoinExchange_HASH_H
