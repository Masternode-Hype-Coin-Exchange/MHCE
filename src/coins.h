...
/** 
    ...
    ****Note - for MasternodeHypeCoinExchange we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of mhce coming in to a transaction
