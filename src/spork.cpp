...
// MasternodeHypeCoinExchange: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // MasternodeHypeCoinExchange: add to spork database.
