...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasternodeHypeCoinExchange mhce-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mhce-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mhce transaction") + "\n" +
                               "  mhce-tx [options] -create [commands]   " + _("Create hex-encoded mhce transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mhce transaction
