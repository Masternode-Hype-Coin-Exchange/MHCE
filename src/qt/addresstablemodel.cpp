...
void AddressTableModel::updateEntry(const QString& address,
    ...
    int status)
{
    // Update address book model from MasternodeHypeCoinExchange
...
{
    emit dataChanged(index(idx, 0, QModelIndex()), index(idx, columhce.length() - 1, QModelIndex()));
}
