...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasternodeHypeCoinExchange"),
     ...
     * override -datadir in the mhce.conf file in the default data directory
     * (to be consistent with mhced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
