...
public:
    ...
    void setZMHCEControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzmhce_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzmhce_clicked();
    void on_pushButtonZMHCEControl_clicked();
