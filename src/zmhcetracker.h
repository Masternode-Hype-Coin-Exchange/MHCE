...
#ifndef MasternodeHypeCoinExchange_ZMHCETRACKER_H
#define MasternodeHypeCoinExchange_ZMHCETRACKER_H
...
public:
    CzmhceTracker(std::string strWalletFile);
    ~CzmhceTracker();
...
#endif //MasternodeHypeCoinExchange_ZMHCETRACKER_H
