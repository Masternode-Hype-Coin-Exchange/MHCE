...
RESOURCES += src/qt/mhce.qrc src/qt/mhce_locale.qrc

TRANSLATIONS += src/qt/locale/mhce_bg.ts \
                src/qt/locale/mhce_de.ts \
                src/qt/locale/mhce_en.ts \
                src/qt/locale/mhce_es.ts \
                src/qt/locale/mhce_fi.ts \
                src/qt/locale/mhce_fr.ts \
                src/qt/locale/mhce_it.ts \
                src/qt/locale/mhce_ja.ts \
                src/qt/locale/mhce_pl.ts \
                src/qt/locale/mhce_pt.ts \
                src/qt/locale/mhce_ru.ts \
                src/qt/locale/mhce_sk.ts \
                src/qt/locale/mhce_sv.ts \
                src/qt/locale/mhce_vi.ts \
                src/qt/locale/mhce_zh_CN.ts \
                src/qt/locale/mhce_zh_TW.ts
