Contributing to MasternodeHypeCoinExchange
============================

The MasternodeHypeCoinExchange project operates an open contributor model where anyone is
...
The following applies to code changes to the MasternodeHypeCoinExchange project, and is not to be
confused with overall MasternodeHypeCoinExchange Network Protocol consensus changes.

Whether a pull request is merged into MasternodeHypeCoinExchange rests with the project merge
...
Patches that change MasternodeHypeCoinExchange consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasternodeHypeCoinExchange consensus, it must have been
...
The project leader is the release manager for each MasternodeHypeCoinExchange release.
